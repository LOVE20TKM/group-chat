...
window.LOVE20_CHAT_PROTOTYPE_DATA = {
  ...
  messages: [
    ...
    { groupId: '1024', senderId: 1029, senderAddress: '0x52...13', round: 42, messageId: 3, content: '@全部 只有 owner、delegate 或 admin 可以发。', mentionedSenderIds: [], mentionAll: true, quotedMessageId: 2, mine: false },
