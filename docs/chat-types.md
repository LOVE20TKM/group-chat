...
| --- | --- | --- | --- |
| 代币社区群聊 | `TokenMainManager` | `TokenMainManager` | `GovVotedDenySource` |
| 代币治理者群聊 | `TokenGovManager` | `TokenGovManager` | `GovVotedDenySource` |
| 代币行动群聊 | `TokenActionMainManager` | `TokenActionMainManager` | `GovVotedDenySource` |
| 代币行动治理者群聊 | `TokenActionGovManager` | `TokenActionGovManager` | `GovVotedDenySource` |
| 链群服务者管理型群聊 | 链群服务者 owner / delegate | `GroupMemberScope` 或 `GroupJoinScopeSource` | `AdminDenySource` |
