...
- `BanSourceSet.prevSourceAddress` 语义固定为“本次修改前生效中的 ban source”
...
- 前端配置同步要求：
- 只把 `ChatActivate`、`ChatDeactivate`、`MetaSet`、`DelegateGroupIdSet`、`ScopeSourceSet`、`BanSourceSet`、`BeforePostPluginSet`、`AfterPostPluginSet` 当作“配置已变更”的信号
